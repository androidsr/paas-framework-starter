...
import paas.framework.web.formatter.DateTimeFormatter;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    private boolean shouldRegisterLinksMapping(WebEndpointProperties webEndpointProperties, Environment environment, String basePath) {
        return webEndpointProperties.getDiscovery().isEnabled() && (PaasUtils.isNotEmpty(basePath) || ManagementPortType.get(environment).equals(ManagementPortType.DIFFERENT));
    }
